...
int main(int argc, char* argv[]) {
  ...
  for (i=0;i<testsample.n;i++) {
	...
	printf("[%d]:GT(%d,%d,%d), Prediction(%d,%d,%d)\n", i, testsample.examples[i].y.action, testsample.examples[i].h.startFrame, testsample.examples[i].h.endFrame, y.action, h.startFrame, h.endFrame );
